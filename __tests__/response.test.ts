...
describe(`Response`, () => {
  it(`Creates a response with default settings`, () => {
  ...
  it(`Creates a response with CORS`, () => {
  ...
  it(`Creates a response without CORS`, () => {
  ...
  it(`Creates a response without response body`, () => {
    const response = Response(204)
    expect(response.statusCode).toBe(204)
    expect(response.headers).toEqual({...corsHeaders, ...securityHeaders})
  })

  it(`Creates a response with Security Headers`, () => {
